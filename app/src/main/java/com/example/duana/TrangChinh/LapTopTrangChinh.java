...
public class LapTopTrangChinh extends AppCompatActivity {
private ArrayList<SanPham>arrayList;
SanphamAdapter1 adapter;
RecyclerView recyclerView;
ImageView back1;
SwipeRefreshLayout swipeRefreshLayout;
String url="https://sanphambanhang.000webhostapp.com/laptop.php";
    private ProgressDialog myProgress;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_laptop);
        recyclerView=findViewById(R.id.listviewLaptop);
        arrayList=new ArrayList<>();
        swipeRefreshLayout=findViewById(R.id.SwipeRefreshLayoutlaptop);
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        adapter = new SanphamAdapter1(LapTopTrangChinh.this, arrayList);
                        recyclerView.setLayoutManager(new GridLayoutManager(LapTopTrangChinh.this, 2));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(LapTopTrangChinh.this, "Bạn bị mất kết nối mạng !", Toast.LENGTH_SHORT).show();
                    }
                }
        );
