...
public class PhuKien extends AppCompatActivity {
    ...
    String url="http://sanphambanhang.000webhostapp.com/PhuKien.php";
    @Override
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        adapter = new SanphamAdapter1(PhuKien.this, arrayList);
                        recyclerViewdienthoai.setLayoutManager(new GridLayoutManager(PhuKien.this, 2));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(PhuKien.this, "Bạn bị mất kết nối mạng !", Toast.LENGTH_SHORT).show();
                    }
                }
        );
