...
public class AdapterGioHangKiemtra2 extends RecyclerView.Adapter<AdapterGioHangKiemtra2.MyViewHolder> {
    private static KiemTra2 context;
    private List<ModelGioHang2> gioHangList;
   public static ModelGioHang2 gioHangl;

    public AdapterGioHangKiemtra2(KiemTra2 context, List<ModelGioHang2> gioHangList) {
