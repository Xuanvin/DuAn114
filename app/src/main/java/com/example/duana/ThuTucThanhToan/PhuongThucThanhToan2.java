...
public class PhuongThucThanhToan2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phuong_thuc_thanh_toan2);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.toolbar:
                ...
                break;
            case R.id.thanhtoan:
                startActivity(new Intent(PhuongThucThanhToan2.this, ThanhToanKhiNhanHang2.class));
