...
import static com.example.duana.ThuTucThanhToan.KiemTra2.gioHangList;
import static com.example.duana.ThuTucThanhToan.KiemTra2.tongcong1;
import static com.example.duana.UserName.LoginApp.userId;

public class ThanhToanKhiNhanHang2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thanh_toan_khi_nhan_hang2);
        ...
        String url = "http://sanphambanhang.000webhostapp.com/giohang2.php";
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.xacnhandonhang:
                DangKi(url3);
              startActivity(new Intent(ThanhToanKhiNhanHang2.this, DonHangDaDuotDat2.class));

        }
    }

    private void DangKi(String url) {
        for (final ModelGioHang2 modelGioHang : gioHangList) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            if (response.trim().equals("success")) {
                                Toast.makeText(ThanhToanKhiNhanHang2.this, "Thêm thành công", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(ThanhToanKhiNhanHang2.this, "Vui  lòng  nhập đày đủ thông tin", Toast.LENGTH_SHORT).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(ThanhToanKhiNhanHang2.this, "loiox mangj", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
