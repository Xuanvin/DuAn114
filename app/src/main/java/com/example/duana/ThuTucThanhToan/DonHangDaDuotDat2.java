...
public class DonHangDaDuotDat2 extends AppCompatActivity implements View.OnClickListener {
    TextView donhangdadat;
    String xoa = "http://sanphambanhang.000webhostapp.com/delete2.php";
    TextView xemdonhang;
    private SharedPreferences preferences;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_don_hang_da_duot_dat2);
       ...
       // xemdonhang.setOnClickListener(this);
        ...
        public void onClick (View v){
            if (v.getId() == R.id.toolbar) {
                Xoa(idicart);
                startActivity(new Intent(DonHangDaDuotDat2.this, MainActivity.class));
                finish();
                //                case R.id.xemdonhang:
//                    startActivity(new Intent(DonHangDaDuotDat2.this, XemDonHang.class));
            }
        }
        ...
        public void Xoa ( final int id){
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, xoa,
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(DonHangDaDuotDat2.this, "Xảy ra lỗi", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
