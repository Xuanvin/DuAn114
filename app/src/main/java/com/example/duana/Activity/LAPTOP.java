...
private ArrayList<ModeLaptop>arrayList;
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        adapter=new LaptopAdapter(LAPTOP.this,arrayList,R.layout.itemgiamgia);
                        recyclerView.setAdapter(adapter);
                        recyclerView.setLayoutManager(new GridLayoutManager(LAPTOP.this, 2));
                        myProgress.dismiss();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(LAPTOP.this, "Mất kết nối mạng !", Toast.LENGTH_SHORT).show();
                    }
                }
        );
