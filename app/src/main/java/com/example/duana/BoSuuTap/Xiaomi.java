...
public class Xiaomi extends AppCompatActivity {
    ...
    String url="http://sanphambanhang.000webhostapp.com/PhoneXiaoMi.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        adapter=new SanphamAdapter1(Xiaomi.this,arrayList);
                        recyclerView.setAdapter(adapter);
                        recyclerView.setLayoutManager(new GridLayoutManager(Xiaomi.this, 2));
                        myProgress.dismiss();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Xiaomi.this, "Mất kết nối mạng !", Toast.LENGTH_SHORT).show();
                    }
                }
        );
