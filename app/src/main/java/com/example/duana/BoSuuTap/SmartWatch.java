...
public class SmartWatch extends AppCompatActivity {
    ...
    String url="http://sanphambanhang.000webhostapp.com/SmartWatch.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        adapter=new SanphamAdapter1(SmartWatch.this,arrayList);
                        recyclerView.setAdapter(adapter);
                        recyclerView.setLayoutManager(new GridLayoutManager(SmartWatch.this, 2));
                        myProgress.dismiss();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(SmartWatch.this, "Mất kết nối mạng !", Toast.LENGTH_SHORT).show();
                    }
                }
        );
